...
public class EncryptionUtil {
	...
	public static void main(String[] args) {
		try {
			String pTest = EncryptionUtil.encrypt("deviceVerNum=2.33&device=1&mobile=99912345&areaCode=852&lang=zh_HK&", DECRYPT_KEY);
			System.out.println(pTest);
			pTest = URLEncoder.encode(pTest, "UTF-8");
			//System.out.println(pTest);

			String decryptTest = EncryptionUtil.decrypt("CE3Q4nD99ifLuqa/TPAy00e4JYguwG1ArU7ST/Yu38j/rOmeSMVeOaUTUg1S4kzhNn9Lvi+F05PbTC0i1H6WkVAUYSOC27ATNO+DR9zsnQA=", DECRYPT_KEY);
			...
			//String decryptTest = EncryptionUtil.decrypt(decryptTest, DECRYPT_KEY);
